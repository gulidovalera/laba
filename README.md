...
- [В3задание2(2).py](https://github.com/gulidovalera/laba/blob/Labi/Python/%23В3задание1.py), [В1задание1(2).py](https://github.com/gulidovalera/laba/blob/лаба-1/В1задание1(2).py) - Лабораторная работа 3
